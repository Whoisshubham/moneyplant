            ...
            <div class="card">
                ...
                <div class="body">
                    <form action="{{route('admin.sliders.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <video src="" id="slider-imgsrc" autoplay="" loop="" id="bg-video" muted="" playsinline="" class="img-responsive"> </video>
                            <input type="file" name="video" id="slider-image-input" style="display:none;">
