            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="WhyBuyPara">
                        <p>
                            We can get you where you want to be your home. Because we understand home is not just a place,
                            it is your emotion that you want to invest in the right place.
    ...
    <section class="WhyBuyBannerSection">
        <div class="container">
            <div class="WhyBuyBannerImg">
                <img src="https://imagedelivery.net/yg9mV_kJZn9RkpQKfOuKfA/e981dcac-fa79-4075-a4e3-3be1ef682f00/public"
                    alt="" srcset="" />
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="salesText mt-4">
                        ...
                        <div class="salePara">
                            <p>
                                We grew from a small property company to an industry. So, we have much knowledge about the
                                places and property. Our consultant can help you make intelligent decisions about where you
                                should invest in the property. We want you to experience quality and safety. We also deliver
                                efficiency, which you need to make your purchase smooth and seamless.
                            </p>
                        </div>
