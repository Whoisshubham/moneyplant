...
@section('content')
 ...
 <section class="" style="margin-top: 130px">
    <div class="container">
      <!-- Modal -->
      <div class="modal fade" id="view-photo" tabindex="-1" aria-labelledby="view-photoLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="view-photoLabel">
                3 Previews
              </h1>
              ...
              <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="https://d2fvuj1ffdxm4a.cloudfront.net/property_image/espace-mar-391081-6871.webp"
                      class="d-block w-100" alt="..." />
                  </div>
                  <div class="carousel-item">
                    <img src="https://d2fvuj1ffdxm4a.cloudfront.net/property_image/espace-mar-391086-2768.webp"
                      class="d-block w-100" alt="..." />
                  </div>
                  <div class="carousel-item">
                    <img src="https://d2fvuj1ffdxm4a.cloudfront.net/property_image/espace-mar-391086-2768.webp"
      ...
      <div class="row g-2">
        <div class="col-lg-6 col-md-12 col-sm-12">
          <button type="button" class="btn btn-light mb-4 ms-3" style="
                margin-top: 10px !important;
                z-index: 100 !important;
                position: absolute;
              " data-bs-toggle="modal" data-bs-target="#view-photo">
            View All
          </button>
          <div class="fullImage" style="position: relative; z-index: 0">
            <img src="https://d2fvuj1ffdxm4a.cloudfront.net/property_image/espace-mar-391081-6871.webp"
              class="ImageFull" alt="" />
          </div>
        </div>
          ...
          <div class="row g-2">
            <div class="col-6">
              <div class="smallImage">
                <img src="https://d2fvuj1ffdxm4a.cloudfront.net/property_image/espace-mar-391082-2987.webp"
                  class="ImageSmall" alt="" />
              </div>
            </div>
            <div class="col-6">
              <div class="smallImage">
                <img src="https://d2fvuj1ffdxm4a.cloudfront.net/property_image/espace-mar-391085-9673.webp"
                  class="ImageSmall" alt="" />
              </div>
            </div>
          </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-12 col-sm-12">
          <div class="mt-4">
            <div class="">
              <h3>Water Front Facing Muse Type 1</h3>
            </div>
            <div class="">
              <p>Elysian Mansions, Tilal Al Ghaf, Dubai</p>
              <p>6 Bedroom Villa For Sale</p>
            </div>

            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-4 mt-2">
                <h5>
                  Price: <span style="color: #1f663a">AED 50,000,000</span>
                </h5>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-4 mt-2">
                <h5>Location: <span class="fs-6">Elysian Mansions</span></h5>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-4 mt-2">
                <h5>Bedrooms: <span class="fs-6">6</span></h5>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-4 mt-2">
                <h5>Size: <span class="fs-6">16961 sqft</span></h5>
              </div>
            </div>

            <div class="mt-4">
              <h4>Key Features & Description</h4>
            </div>
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-4 mt-2">
              ...
              <div class="col-lg-6 col-md-6 col-sm-4 mt-2">
                <p>
                  ...
                  Debitis architecto minus tempora expedita voluptates vero
                  id, quos, hic obcaecati numquam vitae laboriosam! Iusto,
                  placeat aperiam cumque repellendus odit voluptatem facilis
                  impedit. Perferendis cumque sed eos eius excepturi quam?
                  Modi ipsam aperiam ut cum, soluta architecto quia voluptatem
                  aliquid placeat sunt!
                </p>
                <p>- Built-in Kitchen Appliances</p>
                <p>- Community Park</p>
                <p>- Community Park</p>
       ...
       <div class="d-flex col-lg-4 justify-content-end  col-md-12 col-md-12 mt-4 mb-4">
        <div class="">
      ...
      <div>
        ...
        <div class="row border p-3 mt-3">
          <p>Alaya, 29-01-2024</p>
          <div class="col-lg-6 col-md-6 col-sm-4 mt-2">
            <h5>
              Sold Price:
              <span style="color: #1f663a">AED 50,000,000</span>
            </h5>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-4 mt-2">
            <h5>Type: <span class="fs-6">Elysian Mansions</span></h5>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-4 mt-2">
            <h5>Bedrooms: <span class="fs-6">6</span></h5>
          </div>
